...
# looking at the association betwen distance
us_rest %>%
...
# plot looks messy with all the of regression lines
us_rest %>%
  filter(!is.na(city))%>%
        ggplot(aes(x=distance, y=rating)) + geom_point() + labs(title = "Assocation between Distance and Rating") #+ geom_smooth() 
